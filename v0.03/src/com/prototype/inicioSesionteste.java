...
import com.interfaz.iniciosesion.*;
 ...
 * @author macbook
 */
public class inicioSesionteste extends javax.swing.JFrame {
    String pin = "1234";
    int x = 1;
    /**
     * Creates new form inicioSesion
     */
    public inicioSesionteste() {
        initComponents();
    ...
    */
    ...
    private void btnINiMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnINiMousePressed
        try {
            ...
            Logger.getLogger(inicioSesionteste.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inicioSesionteste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new inicioSesionteste().setVisible(true);
            }
        });
    }
